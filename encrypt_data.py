...
def encrypt_data():
    image_encrypt.encrypt(src_dir="F:\projects\Image_encrypt\driving_dataset",
                          dest_dir="F:\projects\Image_encrypt\encrypted_driving_dataset", image_x=100, image_y=100,
                          password="akshay")
